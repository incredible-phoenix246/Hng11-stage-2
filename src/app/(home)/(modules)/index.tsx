...
import { GalleryProps, ImageCardProps, Tabprops } from "@/types";
  ...
  return (
      <main className="container">
        <section className="flex items-center justify-between py-4 overflow-hidden max-w-[1400px place-content-center]">
          <div
              className="min-[900px]:h-[120px] min-[500px]:h-[80px] h-[33.51px] [clip-path:polygon(0%_0%,_90%_0%,_100%_50%,_90%_100%,_0%_100%,_0%_0%)] bg-primary  text-base-white rounded-[4px] md:rounded-[10px] lg:rounded-[16px] lg:w-[400px] min-[500px]:w-[300px] w-[133.65px] flex items-center justify-center py-2">
            <div
                className="flex lg:min-[900px]:w-[342px] md:w-[250px] w-[95px] min-[900px]:h-[82px] md:h-[50px] h-[25px] items-center justify-center text-[48px] lg:gap-x-2 md:gap-x-1 gap-x-0.5">
          ...
          <div
              className="min-[900px]:h-[120px] h-[33.51px] min-[500px]:h-[80px] [clip-path:polygon(0%_0%,_100%_0%,_90%_50%,_100%_100%,_0%_100%,_10%_50%)] bg-secondary  text-base-white lg:w-[400px] min-[500px]:w-[300px] w-[133.65px] flex items-center justify-center">
            <div
                className="flex lg:min-[900px]:w-[342px] md:w-[250px] w-[105px] min-[900px]:h-[82px] md:h-[50px] h-[25px] items-center justify-center text-[48px] lg:gap-x-2 md:gap-x-1 gap-x-0.5">
              <History size={isMobile ? 12 : isTablet ? 32 : 40} strokeWidth={2}/>
              <div className="flex flex-col text-center">
          ...
          <div
              className="min-[900px]:h-[120px] h-[33.51px] min-[500px]:h-[80px] [clip-path:polygon(10%_0%,_100%_0%,_100%_50%,_100%_100%,_10%_100%,_0%_50%)] bg-primary  text-base-white rounded-[4px] md:rounded-[10px] lg:rounded-[16px] lg:w-[400px] min-[500px]:w-[300px] w-[133.65px] flex items-center justify-center">
            <div
                className="flex lg:min-[900px]:w-[342px] md:w-[250px] w-[95px] min-[900px]:h-[82px] md:h-[50px] h-[25px] items-center justify-center text-[48px] lg:gap-x-2 md:gap-x-1 gap-x-0.5">
              <LifeBuoy size={isMobile ? 12 : isTablet ? 32 : 40} strokeWidth={2}/>
              <div className="flex flex-col text-center">
                <p className="text-base-white lg:text-4xl md:text-2xl  min-[500px]:text-lg text-xs font-unica">
                  24/7 SUPPORT
                </p>
...
const tabs: Tabprops[] = [
  ...
  { id: 4, label: "asccessories", tab: "accessories" },
  { id: 5, label: "shoes", tab: "shoes" },
  { id: 6, label: "bags", tab: "bags" },
];

export { HeroSection, GranteeSection, GallerySection };
